...
"use strict";angular.module("invoicio.awesome-module.awesome-controller",[]).controller("awesomeController",["$scope","awesomeService",function(e,o){e.message="This is on the awesome controller scope.",e.message2=o.getMessage()}]);
"use strict";angular.module("invoicio.awesome-module.awesome-directive",[]).directive("awesomeDirective",["$interval",function(e){return{template:"<div>An awesome directive is what I am.</div>",compile:function(){return console.log("tet"),{post:function(o){o.count=0,console.log(o.count),e(function(){o.count=o.count++},1e3)}}}}}]);
"use strict";

angular.module('invoicio.awesome-module', [
    'invoicio.awesome-module.awesome-controller',
    'invoicio.awesome-module.awesome-service',
    'invoicio.awesome-module.awesome-directive'
]);
"use strict";
...
"use strict";angular.module("invoicio",["invoicio.awesome-module"]).config(["$interpolateProvider",function(o){o.startSymbol("{[{").endSymbol("}]}")}]);
